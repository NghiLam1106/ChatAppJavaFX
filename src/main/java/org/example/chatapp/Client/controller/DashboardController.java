...
import org.example.chatapp.Client.interfaces.MessageListener;
import org.example.chatapp.Client.interfaces.ShakeListener;
import org.example.chatapp.Client.interfaces.StatusListener;
import org.example.chatapp.Client.interfaces.UserListener;
...
import static org.example.chatapp.Client.interfaces.StatusListener.userSet;
...
public class DashboardController implements Initializable, StatusListener {
    ...
    private void openErrorWindow(String message) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader((getClass().getResource("/org/example/chatapp/fxml/Error.fxml")));
