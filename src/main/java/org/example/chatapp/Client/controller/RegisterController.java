...
public class RegisterController implements Initializable {
    ...
    private void openSuccessWindow(String message) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader((getClass().getResource("/org/example/chatapp/fxml/Success.fxml")));
    ...
    private void showLodingScreen() {
        ...
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/org/example/chatapp/fxml/Loading.fxml"));
            Scene scene = new Scene(root);
